...
INSTALLED_APPS = [
    ...
    'apps.testimonial.apps.TestimonialConfig',
...
ROOT_URLCONF = 'nails_backend.urls'
...
WSGI_APPLICATION = 'nails_backend.wsgi.application'
...
if do_space is True:
    ...
    AWS_QUERYSTRING_AUTH = get_bool_from_env('AWS_QUERYSTRING_AUTH', True)
